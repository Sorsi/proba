        ...
        <Grid>
          <Cell col={4}>
            <div style={{ textAlign: "center" }}>
              <img id="sorsi-resume" src="Sorsi-resume.png" alt="resume-pic" />
            </div>
            <h2 style={{ paddingTop: "2em" }}>Orsolya Sütő</h2>
            <h4 style={{ color: "grey" }}>Software Developer</h4>
            <hr style={{ borderTop: "3px solid #833fb2", width: "50%" }} />
            <p>
              I prove my persistence with creative solutions and work best when
              I see the whole pistures with the exact goals.
            </p>
            <hr style={{ borderTop: "3px solid #833fb2", width: "50%" }} />
            <h5>Address</h5>
            <p>1045 Budapest</p>
            ...
            <h5>Web</h5>
            <div>
              <a style={{ textDecoration: "none" }} href="https://sorsisorsi.herokuapp.com/" target="_blank" rel="noopener noreferrer">
